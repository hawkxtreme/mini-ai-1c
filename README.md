...
>
> - Главный акцент релиза — интеграция с Конфигуратором 1С: стабильнее чтение и возврат кода через EditorBridge, лучше handoff в основной чат и удобнее быстрые действия `Ctrl + ПКМ`
> - В `Доработать...` появился голосовой ввод прямо в том же поле задачи, а индикатор микрофона стал спокойнее и лучше показывает живой сигнал
