...
- **Портативность (Без установки)**:
  - Приложение может работать как одиночный `.exe` файл.
  - Все необходимые ресурсы (включая MCP-серверы) встроены в бинарный файл и автоматически распаковываются при необходимости.
