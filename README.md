...
<!-- release-news:start -->
> **📋 Последний релиз: версия 1.1.22** — 23 марта 2026
>
> - В шаблоны slash-команд и сценарии MCP можно быстро вставлять инструменты прямо из интерфейса
> - В настройках MCP появился отдельный просмотр инструментов по каждому серверу
> - Исправлены дубликаты MCP-инструментов и обновление состояния отключённых серверов
> - Снижено поведение MCP runtime, вызывавшее ложные срабатывания антивирусов
>
> [Подробнее о релизе →](https://github.com/hawkxtreme/mini-ai-1c/releases/tag/v1.1.22) · [Все релизы →](https://github.com/hawkxtreme/mini-ai-1c/releases)
<!-- release-news:end -->
